...
func (c *Client) GetSpotClearinghouseState(ctx context.Context) (*SpotClearinghouseState, error) {
	req := map[string]string{"type": "spotClearinghouseState", "user": c.mainAddress}
